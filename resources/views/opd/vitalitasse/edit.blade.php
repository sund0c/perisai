...
@section('title', 'Edit Vitalitas SE')
...
@section('content')
    ...
    <form action="{{ route('opd.vitalitasse.update', ['aset' => $aset, 'kategori' => request('kategori')]) }}" method="POST">
        ...
        @foreach ($indikators as $indikator)
            @php
                ...
                $saved = is_array($vitalitasSe->jawaban ?? null) ? $vitalitasSe->jawaban : [];
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            @if (strtolower($indikator->kode) === 'i6')
                                ...
                                <small class="form-text text-muted">Pilih data pribadi yang relevan sebagai keterangan untuk
                                    indikator ini.</small>
                            @else
                    ...
                    $.ajax({
                            ...
                            try {
                                ...
                                const selectizeInstance = $keteranganSelect.selectize({
                                    ...
                                    onItemAdd: function(value, $item) {
                                        ...
                                        const stringValue = Array.isArray(values) ?
                                            values.join(', ') : values;
                                ...
                                console.error('Error initializing Selectize keterangan:',
                                    error);
                            }
                        ...
                        error: function(xhr, status, error) {
                            ...
                            try {
                                ...
                                console.error(
                                    'Fallback Selectize keterangan initialization failed:',
                                    fallbackError);
                            }
                        }
                    });
