...
<head>
    <meta charset="utf-8">
    <title>Export PDF Range Kategori SE</title>
    <style>
        table {
            width: 100%;
...
<body>
    <h2>Daftar Range Kategori SE</h2>
            ...
            @foreach ($rangeSes as $item)
                <tr>
                    ...
                    <td class="f12">
                        {{ $item->warna_hexa }}
                        <span
                            style="background-color: {{ $item->warna_hexa }}; display:inline-block; width:20px; height:10px;"></span>
                    </td>
