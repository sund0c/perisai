        ...
        <div class="card-body">
            <form action="{{ route('periodes.update', $periode->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="tahun" class="form-control" value="{{ old('tahun', $periode->tahun) }}"
                        required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control" required>
                        <option value="open" {{ old('status', $periode->status) == 'open' ? 'selected' : '' }}>Open
                        </option>
                        <option value="closed" {{ old('status', $periode->status) == 'closed' ? 'selected' : '' }}>Closed
                        </option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="kunci" class="form-control" required>
                        ...
                        <option value="locked" {{ old('kunci', $periode->kunci) == 'locked' ? 'selected' : '' }}>Locked
                        </option>
                    </select>
                </div>
