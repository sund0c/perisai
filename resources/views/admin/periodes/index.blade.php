...
@section('content')
    ...
    @if ($errors->any())
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Terjadi kegagalan.</strong> Pastikan semua form sudah terisi.
            {{-- <ul class="mb-0 mt-2">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="d-flex" style="gap: 5px;">
                                    ...
                                    <form action="{{ route('periodes.destroy', $periode) }}" method="POST"
                                    ...
                                    @if ($periode->status !== 'open')
                                        <form action="{{ route('periodes.activate', $periode) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            <button class="btn btn-success btn-sm" title="Buka Tahun"><i
