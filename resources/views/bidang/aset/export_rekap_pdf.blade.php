        ...
        <tbody>
            ...
            @foreach ($asets as $aset)
                <tr>
                    ...
                    <td>
                        {{ optional(optional($aset->subklasifikasiaset)->klasifikasi)->klasifikasiaset ?? optional($aset->klasifikasi)->klasifikasiaset ?? '-' }}<br>
                        {{ optional($aset->subklasifikasiaset)->subklasifikasiaset ?? '-' }}<br>
